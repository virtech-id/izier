	...
	"inline-flex justify-center items-center font-medium rounded-md px-4 py-2 text-sm transition duration-300 ease-in-out",
	{
		variants: {
			intent: {
				...
				subtle:
					"bg-whiteA-12 text-grayDark-1 whitespace-nowrap transition drop-shadow-glow-sm duration-2000 hover:transition hover:drop-shadow-glow-md hover:duration-500",
				destructive:
					"bg-redDark-6 text-whiteA-12 whitespace-nowrap hover:bg-redDark-8",
				ghost:
					"bg-whiteA-1 text-whiteA-10 hover:bg-whiteA-8 whitespace-nowrap hover:text-whiteA-12",
			},
			outlined: {
